  ...
  return (
    <section className="py-16 bg-white text-center">
      <div className='mb-16'>
        ...
        <span className='w-40 h-[3px] bg-[#172E4D] block mx-auto'></span>
      </div>
      <p className="text-lg italic text-gray-600 mb-10">
        Hun Hsin Textile Co., (BD) Ltd. stands as a trusted nylon yarn supplier, committed to quality, customization, and global service excellence.      </p>
