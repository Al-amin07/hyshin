...
const advantages = [
  ...
  },
  {
    ...
    description:
      "We maintain a high level of production efficiency and reliability.",
  },
  {
    icon: <FaTruck />,
    ...
    <div>
      <div className="grid   md:grid-cols-2 lg:grid-cols-4 gap-6 grid-cols-1   bg-white">
        {advantages.map((item, index) => (
          ...
          >
            <div className="flex flex-col items-center  border-4 border-dotted border-gray-400/90 rounded-full  justify-center text-center h-52 w-52 relative">
              <div className="text-5xl text-[#172E4D] mb-4">{item.icon}</div>
              <h3 className="  leading-relaxed">{item.title}</h3>
            ...
            <div
              className="bg-white  px-4 py-3 mt-12 pt-12 pb-8 border-t-2 border-[#172E4D] text-gray-700 
