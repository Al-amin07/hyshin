...
export default function Banner({ img, text }: { img: string | StaticImport, text: string }) {
    return (
        ...
        >
            <Image src={img} alt='vsdv' className='h-full w-full object-cover' fill />
            <div className="flex items-center relative z-30 min-h-[500px]  md:min-h-screen justify-between w-full bg-gray-900/30">
                <div data-aos="fade-up-left" data-aos-delay="500" className="container mx-auto px-6  w-full">
                    ...
                    <h1 className={`text-xl  pt-0 font-semibold mt-10 mb-12 sm:text-2xl md:text-4xl  text-white text-center  leading-relaxed  lg:text-5xl ${playDisplay.className}`}>{text}
                    </h1>
